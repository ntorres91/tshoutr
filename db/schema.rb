...
ActiveRecord::Schema.define(version: 20141024052927) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "follower_and_followed_user", unique: true, using: :btree
